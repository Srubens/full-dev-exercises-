 ...
 * 
Aula 02 - Exercícios
​1) Em linguagens síncronas é comum a função sleep(tempo) assim, pode-se por exemplo 
escrever algo no console, pausar o script por x tempo e escrever algo mais algo como:
...
console.log('Este vai vim primeiro')
sleep(2000)
console.log('Este aqui vai vim no 1 segundo.')

console.log('---------------------------------------------------------')
console.log(`
2) A função readdir disponível no módulo fs do Node, permite ler um diretório, 
...
readDir('./')
.then(data =>{
    console.log('Arquivo da pasta lidos')
    console.log(String(data))
})
.catch(err => console.log(`Erro no arquivo: ${err}`))
console.log('---------------------------------------------------------')
